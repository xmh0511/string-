...
namespace xmh
{
    ...
    public:
        bool write_to_file(const String& fileName,write_file_mode mode = write_file_mode::full) const
        {
    ...
    std::ostream& operator<<(std::ostream& out,const xmh::String& str)
    {
        out<<str.c_str();
        return out;
    }
